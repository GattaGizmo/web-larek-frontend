...
import { ICardProductActions, ICardProduct } from "../../types";
import { formatNumberWithSpaces } from "../../utils/utils";

export class CardProductView extends Component<ICardProduct> {
	protected _category: HTMLElement;
	protected _title: HTMLElement;
	protected _image: HTMLImageElement;
	protected _price: HTMLElement;
	protected _data: ICardProduct;
	protected _button: HTMLButtonElement;

	constructor(protected blockName: string, container: HTMLElement, actions?: ICardProductActions) {
		super(container);
...
export class CatalogueItem extends CardProductView {
	constructor(container: HTMLElement, actions?: ICardProductActions) {
		super('card', container, actions);
	}
}

export class CatalogueItemPreview extends CardProductView {
